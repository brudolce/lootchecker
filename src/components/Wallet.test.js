...
describe('Wallet', () => {
  ...
  describe('when the user types into the wallet input', () => {
    ...
    it('updates the local wallet balance in state and convers it to a number', () => {
      expect(wallet.state().balance)
    ...
    describe('and the user wants to make a withdrawal', ()=>{
      ...
      it('dispatches the `withdraw()` it receives from pros with the local balance', ()=>{
